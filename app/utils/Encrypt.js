...
/**
 * Encryption algorithm wrapper that provides 3 various hashing functions
 */
class Encrypt {
	 ...
	 * @param str
	 */
	static b64_sha256(str) {
		return binb2b64(core_sha256(str2binb(str), str.length * chrsz));
	}
	 ...
	 * @param str
	 */
	static str_sha256(str) {
		return binb2str(core_sha256(str2binb(str), str.length * chrsz));
	}
}
